...
do
    ...
    do
        ...
        CUDA_VISIBLE_DEVICES=${dyn_seed} python scripts/run_combostyle.py --maze_config_file ${maze} \
    ...
    #     CUDA_VISIBLE_DEVICES=1 python scripts/run_combostyle.py --maze_config_file ${maze} \
    #                                     --cql_seed ${dyn_seed} --seed ${dyn_seed} \
    #                                     --horizon ${horizon} \
    #                                     --final_ckpt_path ${final_ckpt_path} \
    #                                     --load-dynamics-path ${dynamics_path} \
