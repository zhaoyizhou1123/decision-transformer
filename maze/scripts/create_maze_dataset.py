...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_file', type=str, default=None,help='./dataset/maze2_simple_expert.dat')
    parser.add_argument('--horizon', type=int, default=200)
    parser.add_argument('--debug', action='store_true')
    parser.add_argument('--render', action='store_true')
    parser.add_argument('--maze_config_file', type=str, default='./config/maze2_simple_expert_slow.json')
