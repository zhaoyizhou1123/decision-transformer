...
class FullyConnectedQFunction(nn.Module):
    ...
    def __init__(self, observation_dim, action_dim, embd_dim, horizon, arch='256-256', orthogonal_init=False):
        '''
        ...
        # )
        self.network = FullyConnectedNetwork(
            observation_dim + action_dim + 1, 1, arch, orthogonal_init
        )
    ...
    def forward(self, observations, actions, timesteps):
        ...
        input_tensor = torch.cat([observations, actions, timesteps], dim=-1)
